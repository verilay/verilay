...
const LOG_LEVEL: TLogLevelName = process.env.VERILAY_CLIENT_LOG_LEVEL ? process.env.VERILAY_CLIENT_LOG_LEVEL as TLogLevelName : 'info';
...
export const setLogger = (name: string, minLevelString: string) => {
    ...
    process.env.VERILAY_CLIENT_LOG_LEVEL = minLevelString;
